<template>
    <div class="product-list">
      ...
      <div v-if="selectedProduct" class="product-modal-overlay" @click="closeModal">
...
const expandedProductIds = ref<number[]>([]);
  ...
  const truncatedDescription = (description: string) => {
    return description.length > MAX_LENGTH ? description.substring(0, MAX_LENGTH) + '...' : description;
  };
